...
6. Registre tudo num único `propor_patch`:
   ...
   - a `Decision` que você tomou no meio do caminho, se tomou alguma, só com o `produz`: devolva o id em `Decision:`, e o orquestrador decide se ela passa a governar a tarefa;
...
- Criar Task. Tarefa nova é do orquestrador; diga no resumo o que falta.
