...
7 módulos · 1022 linhas · 10 classes
...
| [`api/cli_execucao_grafo.py`](#apicliexecucaografo) | 208 | Manipuladores dos subcomandos que operam sobre um grafo já aberto. |
| [`api/cli_parser.py`](#apicliparser) | 280 | Construção do analisador de argumentos da linha de comando do Graphow. |
