...
- `promover_aprendizado(argumentos: Mapping[str, Any]) -> dict[str, Any]` — Dá alcance ao Aprendizado: `vale_para` um Projeto ou Setor, ou a marca global; sem alvo, o Setor de origem.
