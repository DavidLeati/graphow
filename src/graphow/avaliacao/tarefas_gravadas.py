...
A métrica de avaliação é "tokens por tarefa bem-sucedida". Não havia tarefa
gravada nem medição: o único número existente era "447 para 184 tokens" de uma
vista, numa mensagem de commit. Este módulo é o corpus que faltava — dez
tarefas com restrições, decisões, evidências, dependências e uma escalação,
montadas sempre da mesma forma para que a medição seja comparável entre
execuções.
"""
