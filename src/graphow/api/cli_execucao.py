...
class ExecutorLinhaDeComando:
    ...
    def _executar_avaliar(self, contexto: ContextoExecucao) -> int:
        ...
        A metrica principal nao era medida: o unico numero existente
        vinha de uma mensagem de commit sobre uma vista.
        """
    ...
    def _conferir_guias(self, contexto: ContextoExecucao) -> int:
        ...
        silencio, e dois deles subiam o servidor MCP sem `--papel`.
        """
