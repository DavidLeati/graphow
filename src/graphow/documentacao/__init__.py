...
A documentação mantida à mão diverge do código em silêncio: já houve três
contagens diferentes de ferramentas MCP e duas promessas que o código
contradizia. Aqui o catálogo é derivado do AST, e um
