...
# que o arquivo .db sozinho não enxerga.
...
# Bancos escritos antes de existir esta coluna nao tem o campo. Acrescenta-la mantem as linhas
...
# um fork repetido duplica posicoes e o replay deixa de ser deterministico.
...
class SQLiteEventStore(RepositorioEventos):
    ...
    def _garantir_coluna_de_versao(self, cursor: sqlite3.Cursor) -> None:
        """Acrescenta a coluna de versao da ontologia a bancos que ainda nao a tem."""
