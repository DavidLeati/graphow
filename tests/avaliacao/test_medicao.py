...
def test_corpus_tem_dez_tarefas_gravadas_nominal() -> None:
    """O corpus exige dez tarefas reais gravadas; menos que isso não é corpus."""
...
def test_intervencao_humana_e_contada_na_tarefa_escalada_nominal() -> None:
    """A dúvida respondida pelo humano é a intervenção que entra nessa contagem."""
...
def test_relatorio_declara_os_proprios_limites_nominal() -> None:
    """O número viaja junto do que ele não prova."""
