...
argumentos) não capturam falhas estruturais como arestas soltas, escrita
parcial num lote rejeitado ou ciclos de dependência. O que importa é o que
precisa ser verdade depois de qualquer sequência de escritas.
"""
